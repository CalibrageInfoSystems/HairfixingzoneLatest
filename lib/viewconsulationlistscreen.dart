...
class viewconsulationlistscreen extends StatefulWidget {
  ...
  const viewconsulationlistscreen(
      {super.key,
        ...
        required this.agent,required this.userid});
                      ...
                      showCustomDateRangePicker(
                        ...
                        onApplyClick: (s, e) {
                          setState(() {
                            ...
                            endDate = e;
                            startDate = s;
                            fromToDates.text = '${startDate != null ? DateFormat("dd, MMM").format(startDate!) : '-'} / ${endDate != null ? DateFormat("dd, MMM").format(endDate!) : '-'}';
                        ...
                        if (data.isEmpty) {
                          ...
                          return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                DateTime createdDateTime = DateTime.parse(consultationslist[
                                index]
                                    .createdDate,);
                                month = DateFormat('MMM').format(createdDateTime);
                                date = DateFormat('dd').format(createdDateTime);
